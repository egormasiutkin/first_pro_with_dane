...
/**
  ...
  *
  *  PC15 is where switch is connected for Color / Monochrome
  *
  *  Things left to fix -
  *    * Fix scrolling on Screen0x01...
...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define SLAVE1_ADDR 0x0E			// Must set on LSB 4bits but any value in 0x00 ~ 0x0F
/* USER CODE END PD */
