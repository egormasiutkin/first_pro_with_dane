...
void LCD_Write_Block(unsigned char *ptr, unsigned int len);
...
void GTFont_Select_GT23L32S4W_GT23H32S4W(void);	// <--- We have this chip
...
//void Show_picture2(unsigned long numbers,const unsigned short *datap);
...
void Show_picture2_mono(unsigned long numbers,const unsigned char *datap);
...
void Show_pictureX2_mono(unsigned long w,unsigned long h,const unsigned char *datap);
void Show_greenPicture(unsigned long w,unsigned long h,const unsigned char *datap);
void Put_pixel(unsigned short x, unsigned short y, unsigned long color);
#endif//__RA8876_H__
